...
/**
 * This class is used by components that catches underlying exceptions and
 * re-throw them. The underlying exception is wrapped as a linked exception.
 * This way the components have control of the type of exceptions they want to
 * throw while not losing the real exception stack trace.
 * 
 * @author xial
 */
public class CommonException extends Exception implements Externalizable {
	...
	// constructors
	// =========================================================================
	public CommonException(String why, int errCode, Throwable t) {
	...
	public CommonException(String why) {
		this(why, 0, null);
	}

	public CommonException(String why, int errCode) {
		this(why, errCode, null);
	}

	public CommonException(String why, Throwable t) {
		this(why, 0, t);
	}
	 ...
	 */
	public CommonException addMessage(String msg) {
		if (null != message) {
			message += "\n" + msg;
		} else {
			message = msg;
